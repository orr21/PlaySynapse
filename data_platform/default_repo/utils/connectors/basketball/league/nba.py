...
from default_repo.utils.connectors.basketball.api_core import (
    StatsAPIClient,
    ParameterBuilder,
)
    ...
    def fetch_data(
        ...
        **kwargs,
        ...
        if metric_type == "season_teams":
            ...
            params = ParameterBuilder.build_game_log_params(
                season, league_id=self.league_id
            )
